 ...
 * Original file: /Users/k/override/override/src/android/override/location/ILocationListener.aidl
 */
package android.override.location;
public interface ILocationListener extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements android.override.location.ILocationListener
{
private static final java.lang.String DESCRIPTOR = "android.override.location.ILocationListener";
...
/**
 * Cast an IBinder object into an android.override.location.ILocationListener interface,
 * generating a proxy if needed.
 */
public static android.override.location.ILocationListener asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof android.override.location.ILocationListener))) {
return ((android.override.location.ILocationListener)iin);
}
return new android.override.location.ILocationListener.Stub.Proxy(obj);
}
...
private static class Proxy implements android.override.location.ILocationListener
{
