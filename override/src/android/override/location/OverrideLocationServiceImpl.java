...
public class OverrideLocationServiceImpl extends IOverrideLocationService.Stub {
    ...
    LocationWorkerHandler mLocationHandler = new LocationWorkerHandler();
    ...
    public void requestLocationUpdates(String provider, boolean singleShot, ILocationListener listener) {
        try {
            synchronized (mLock) {
                requestLocationUpdatesLocked(provider, singleShot, getReceiver(listener));
            }
    ...
    private void requestLocationUpdatesLocked(String provider, boolean singleShot, Receiver receiver) {
